...
export default function Home() {
  ...
  return (
    <div className="flex align-middle items-center justify-center ">
      <main className="flex min-h-screen flex-col md:flex-row items-center justify-between md:gap-2">
        ...
        <div className="flex gap-4 m-2 flex-row flex-wrap md:flex-col">
          <a
          ...
          <a
            href="https://t.me/blinktochatbot"
            className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 "
            target="_blank"
            rel="noopener noreferrer"
          >
